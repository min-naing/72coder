...
"use strict"
    ...
    $('.minus').on('click', function(event) {
        ...
        var $e = $(this);
        var $ele = $e.parent().next().find('input.quntity-input');
        var value = $ele.val();
        if(isNaN(value) || value == 1) {
            $ele.val('1');
        } else {
            $ele.val( +value + (1 * $(this).data('multi')) );
        }
    ...
    $('.plus').on('click', function(event) {
        ...
        var e = $(this);
        var $ele = e.parent().prev().find("input.quntity-input");
        var value = $ele.val();
        if( isNaN(value) ) {
            $ele.val('1');
        } else {
    ...
    /*$(".ddd").on("click", function () {
        ...
        $input.val(function(i, value) {
            ...
            var $result = value + ( 1 * +$button.data('multi'));
