            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-xs-6 ">
                        <div class="product-box">
                            <div class="">
                                <img src="{{ asset('images/web_development.png') }}" class="img-responsive service" alt="">
                            </div>
                            <div class="product-detail" align="center">
                    ...
                    <div class="col-lg-3 col-xs-6 ">
                        <div class="product-box">
                            <div class="">
                                <img src="{{ asset('images/android_development.png') }}" class="img-responsive service" alt="">
                            </div>
                            <div class="product-detail" align="center">
                    ...
                    <div class="col-lg-3 col-xs-6 ">
                        <div class="product-box">
                            <div class="">
                                <img src="{{ asset('images/android_advanced.png') }}" class="img-responsive service" alt="">
                            </div>
                            <div class="product-detail" align="center">
